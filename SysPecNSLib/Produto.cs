...
namespace SysPecNSLib
{
    public class Produto
    {
        ...
        public Produto(int id, string? codBar, string? descricao, double valorUnit, string? unidadeVenda, Categoria? categoria, double estoqueMinimo, double classeDesconto, byte[]? imagem)
        {
            Id = id;
            CodBar = codBar;
            Descricao = descricao;
